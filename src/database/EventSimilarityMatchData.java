...
public class EventSimilarityMatchData {
	...
	public EventSimilarityMatchData(String movieName, int matchCount, int totalCount, String[] EventSimilarityMatches, String[] plotEventSimilarityMatches){
	...
	public EventSimilarityMatchData(String movieName, int matchCount, int totalCount, ArrayList<String> EventSimilarityMatches, ArrayList<String> plotEventSimilarityMatches){
		this.movieName = movieName;
		this.matchCount = matchCount;
		this.totalCount = totalCount;
		this.threshold = 0.8;
